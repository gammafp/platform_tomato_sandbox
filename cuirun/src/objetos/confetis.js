...
class Confetis {
    ...
    createConfetis() {
        ...
        anim[this.frames.name] = this.scene.anims.create(config);

        const particle = this.scene.add.particles(this.key);
        const particles = particle.createEmitter({
...
const constructorConfeti = (Scene) => {
...
export default constructorConfeti;